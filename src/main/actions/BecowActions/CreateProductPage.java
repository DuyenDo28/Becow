...
//	}
	...
	public void clickOnEditProduct() {
		waitVisible(CreateProductPageUI.EDITPRODUCT_ISCREATED);
		clickRandomCombobox(CreateProductPageUI.EDITPRODUCT_ISCREATED);
	}

	public void clickOnEditQuantity() {
		waitVisible(CreateProductPageUI.EDITQUANTITY_ICON);
		clickRandomCombobox(CreateProductPageUI.EDITQUANTITY_ICON);
	}

	public void editQuantity(String value) {
		waitVisible(CreateProductPageUI.EDITQUANTITY_TXT);
		clearText(CreateProductPageUI.EDITQUANTITY_TXT);
		input(CreateProductPageUI.EDITQUANTITY_TXT, value);
	}

	public void clickOnUpdateQuantity() {
		waitVisible(CreateProductPageUI.UPDATEQUANTITY_BTN);
		click(CreateProductPageUI.UPDATEQUANTITY_BTN);
	}

	public void clickOnXemChiTietSP() {
		waitVisible(CreateProductPageUI.XEMCHITIETSP_BTN);
		click(CreateProductPageUI.XEMCHITIETSP_BTN);
	}

	public String getTextHetHangLBL() {
		waitVisible(CreateProductPageUI.HETHANG_LBL);
		return getText(CreateProductPageUI.HETHANG_LBL);
	}

	public String getTextJS(String javascript) throws InterruptedException{
		Thread.sleep(2000);
		return getTextByJquery(javascript);
		
	}

	public void inputOnSKU(String value) {
		waitVisible(CreateProductPageUI.SKU_TXT);
		input(CreateProductPageUI.SKU_TXT, value);
	}
	public void hoverOnProductName(String productName) {
		String abc = CreateProductPageUI.PRODUCTNAME_CREATED_HOVER.replace("{abc}", productName);
		waitVisible(abc);
		hover(abc);
	}
	public void clickOnProductName(String productName) {
		String abc = CreateProductPageUI.PRODUCTNAME_CREATED.replace("{abc}", productName);
		waitVisible(abc);
		click(abc);
	}
//	public String getTextWidthLBL(){
//		waitVisible(CreateProductPageUI.WIDTH_LBL);
//		return getText(CreateProductPageUI.WIDTH_LBL);
//		
//	}
//	public String getTextLengthLBL(){
//		waitVisible(CreateProductPageUI.LENGTH_LBL);
//		return getText(CreateProductPageUI.LENGTH_LBL);
//		
//	}
//	public String getTextHeightLBL(){
//		waitVisible(CreateProductPageUI.HEIGHT_LBL);
//		return getText(CreateProductPageUI.HEIGHT_LBL);
//		
//	}
	public String getTextDynamicMsg(String value) {
		waitVisibleDynamicElement(CreateProductPageUI.DYNAMIC_MSG, value);
		return getTextDynamicElement(CreateProductPageUI.DYNAMIC_MSG, value);
